...
#   it "can find_registration_numbers_for_cars_with_colour : White" do
...
#   end
#
#     it "can find_slot_numbers_for_cars_with_colour : White" do
#     run_command(pty, "slot_numbers_for_cars_with_colour \n")
#     run_command(pty, "leave 1\n")
#     expect(fetch_stdout(pty)).to end_with("Slot number 1 is free\n")
#   end
#
#     it "can find_slot_number_for_registration_number : KA-01-HH-3141" do
#     run_command(pty, "park KA-01-HH-3141 Black\n")
#     run_command(pty, "leave 1\n")
#     expect(fetch_stdout(pty)).to end_with("Slot number 1 is free\n")
#   end
