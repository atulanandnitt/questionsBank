...
def get_movie_dimension(movie_container):
    ...
    """
    exp_list = list()
    experience = movie_container.find(
...
def get_booking_link(movie_content):
    """
...
def parse_content(html_content):
    ...
    for movie_container in movie_container_list:
        ...
        movie_dict['particular_movie_link'] = get_booking_link(movie_container)


        movie_content=get_movie_page_contents(movie_dict['particular_movie_link'])
