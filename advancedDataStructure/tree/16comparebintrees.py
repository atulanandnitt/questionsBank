...
def compareTrees(r1, r2):
        if not (r1.l) and not (r1.r) and not (r2.l) and \
                not (r2.r) and r1.v == r2.v:
                return True 

        if (r1.v != r2.v) or (r1.l and not r2.l) or \
                (not r1.l and r2.l) or (r1.r and not r2.r) \
                or (not r1.r and r2.r):
                return False

        l = compareTrees(r1.l, r2.l) if r1.l and r2.l else True
        r = compareTrees(r1.r, r2.r) if r1.r and r2.r else True
        return l and r
