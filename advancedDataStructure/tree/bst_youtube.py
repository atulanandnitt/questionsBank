# -*- coding: utf-8 -*-
"""
Created on Sun Dec 31 13:04:56 2017
...
class Node:
    ...
    def __str__(self): #used for preorder transversal function
        if self.parent:
    ...
    def _add(self,new_node):
        # print ("Node _add:" +str(new_node.data) + 'tc' + str(self.data))
    ...
    def _split(self):
        ...
        right_child = Node(self.data[0],self)
        
        if self.child:
            self.child[0].parent = self_child
