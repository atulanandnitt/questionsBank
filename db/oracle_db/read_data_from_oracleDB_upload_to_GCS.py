...
class EBS_To_GCS():
    def __init__(self):
        ...
        self.filepath = "D:/notes/GCP/KPI/convertToPython/gcp-dwh/src/main/resources/scripts/KPI_ANALYTICS/TableNames_PrimaryKey.csv"
        ...
        if type == 'fullLoad':
            ...
            with open(self.filepath, 'r') as fr:
                ...
                for line in fr:
                    ...
                    fileName = 'gs://resources_for_gcp_dwh/input_data/' + table_name + '.csv'
