...
def word_break_dp(given_string, dictionary):
    ...
    # -1 indicates the word cannot be split.DP matix is created
...
if __name__ == '__main__':
    ...
    if True == is_word_break_possible(given_string, dictionary):
        print(word_break_dp(given_string, dictionary))

    dictionary = {"pea", "nut", "peanut", "butter"}
    given_string = "peanutbutter1"
    if True == is_word_break_possible(given_string, dictionary):
        print(word_break_dp(given_string, dictionary))