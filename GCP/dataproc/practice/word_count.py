...
#my-test-project-234911.sales.product_full_info_str
...
table_data = sc.newAPIHadoopRDD(
    ...
    conf=conf)
# pprint.pprint("type(table_data)", type(table_data))
pprint.pprint(type(table_data))
...
# Display 10 results.
pprint.pprint(word_counts.take(15))

pprint.pprint(type(word_counts))
